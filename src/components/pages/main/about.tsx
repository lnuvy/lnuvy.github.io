        ...
        <div className="w-full flex flex-col md:flex-row gap-8 items-start mb-12">
          <div className="flex-1 space-y-4">
            ...
            <div className="text-lg leading-relaxed text-text-2 space-y-4">
              <p>기업의 비즈니스 모델에 맞춰 생각하고, 코드로 풀어내는 확신을 가진 프론트엔드 개발자입니다.</p>
              <p>
                초기 스타트업 0 to 1에서부터 명확한 비즈니스 임팩트를 만들어 냈고, B2B SaaS 소프트웨어 개발을 거쳐
                현재는 <b>MAU 800만</b>, 누적 회원가입자 수 <b>400만</b>의 비대면 진료 업계 1위 서비스 <b>닥터나우</b>
                에서 웹과 앱을 개발하고 있습니다.
              </p>
              <p>
                항상 와우모먼트를 먼저 생각합니다. 초기 제품 ffeed에서 첫 기획전으로 <b>DAU 10,000, 월 매출 6천만원</b>
                을 달성시키고, Frontend 팀장으로 일할 수 있었던 러너스에서는 전환율을 올릴 수 있는 방법을 주도적으로
                고민하고, 실제로 <b>회원가입 전환율 2배</b>, <b>콘텐츠 이탈률 70% 감소</b> 등의 명확한 비즈니스 임팩트를
                만들어냈습니다.
              </p>
              <p>
                위버케어에서는 MFE <b>초기 렌더링 10배 이상 개선</b>, DX 경험 향상을 위한 고민을 하며 성장해왔고,
                닥터나우에서는 고도화되어있는 서비스 안정성을 토대로 프로젝트를 정리하고 새로운 방향을 제시하고
                있습니다.
              </p>
            </div>
          </div>
