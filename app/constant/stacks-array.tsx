...
export const stacksArray = [
  ...
  },
  {
    ...
    name: 'TypeScript',
    isPublic: 1,
    desc: '자바스크립트 개발자의 기본 소양은 React도, Next.js도 아닌 TS라고 생각합니다. 협업의 기본이자, 프로덕트의 안정성을 끌어올리는 좋은 도구입니다.',
  ...
  },
  {
    ...
    name: 'Next.js',
    isPublic: 1,
    desc: '현재 근무중인 Runners에서 React 프로덕트를 Next.js 14^ 버전으로 마이그레이션하는 업무를 맡았으며, 기존 프로젝트의 코드를 이질적으로 변하지 않기 위해 react-query를 이용한 HydrateBoundary와 Dehydrate를 통해 SSR을 구현합니다.',
    svg: <Next />,
  ...
  },
  {
    ...
    name: 'AWS',
    isPublic: 1,
    desc: 'Spring Boot JPA로 만든 REST-API와 파이썬 flask 서버를 EC2로 배포한 경험이 있고, SPA 배포가 간편한 S3를 애용합니다.',
    svg: <Aws />,
